class AllcarModelClass {
  ...
  AllcarModelClass.fromJson(dynamic json) {
  ...
  static List<AllcarModelClass> listFromJson(List<dynamic> json) {
    return json == null
        ? []
        : json.map((value) => AllcarModelClass.fromJson(value)).toList();
  }
//convert in to list code
