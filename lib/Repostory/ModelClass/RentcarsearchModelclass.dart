class RentcarsearchModelclass {
  ...
  RentcarsearchModelclass.fromJson(dynamic json) {
  ...
  static List<RentcarsearchModelclass> listFromJson(List<dynamic> json) {
    return json == null
        ? []
        : json.map((value) => RentcarsearchModelclass.fromJson(value)).toList();}
