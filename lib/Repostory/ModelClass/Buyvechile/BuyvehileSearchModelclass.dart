class BuyvehileSearchModelclass {
  ...
  BuyvehileSearchModelclass.fromJson(dynamic json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    map['latestModel'] = latestModel;
    map['highMilage'] = highMilage;
    map['__v'] = v;
    return map;
  }
  //convert in to list code
  static List<BuyvehileSearchModelclass> listFromJson(List<dynamic> json) {
    return json == null
        ? []
        : json.map((value) => BuyvehileSearchModelclass.fromJson(value)).toList();
  }
//convert in to list code
